...
def menu():
      while True:
           ...
           print('\033[1;96m ============================================================')
           print(' ||  +--------------------------------------------------+  ||')
           print(' ||  | Creator   : roy404                             |  ||')
           print(' ||  +--------------------------------------------------+  ||')
           print(' ||  | Youtube   : https://youtube.com/c/assassin    |  ||')
           print(' ||  | github    : https://github.com/assasin      |  ||')
           print(' ||  | WhatsApp  : 081227708390                         |  ||')
           print(' ||  | Team      : Cybercrime kudus404                |  ||')
           print(' ||  +--------------------------------------------------+  ||')
           print(' ============================================================')
           print("")
           try:
